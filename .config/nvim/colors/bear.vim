...
if &t_Co > 255
   if s:bear == 1
      ...
      hi Normal       ctermfg=144 ctermbg=235
   ...
   hi Character       ctermfg=71
   hi Number          ctermfg=178
   hi String          ctermfg=71
   hi Conditional     ctermfg=74               cterm=none
   hi Constant        ctermfg=209               cterm=none
   hi Cursor          ctermfg=16  ctermbg=144
   hi Debug           ctermfg=225               cterm=none
   hi Define          ctermfg=81
   hi Delimiter       ctermfg=241

   hi DiffAdd         ctermfg=235 ctermbg=71
   ...
   hi Identifier      ctermfg=244               cterm=none
   hi Ignore          ctermfg=244 ctermbg=232
   hi IncSearch       ctermfg=144 ctermbg=0

   hi keyword         ctermfg=74               cterm=none
   hi Label           ctermfg=162               cterm=none
   hi Macro           ctermfg=193
   hi SpecialKey      ctermfg=81

   hi MatchParen      ctermfg=74  ctermbg=233 cterm=none
   hi ModeMsg         ctermfg=229
   hi MoreMsg         ctermfg=229
   hi Operator        ctermfg=71

   " complete menu
   hi Pmenu           ctermfg=74  ctermbg=0
   hi PmenuSel        ctermfg=0  ctermbg=144
   hi PmenuSbar       ctermfg=0  ctermbg=235
   hi PmenuThumb      ctermfg=81

   hi PreCondit       ctermfg=162               cterm=none
   hi PreProc         ctermfg=162
   hi Question        ctermfg=81
   hi Repeat          ctermfg=162               cterm=none
   hi Search          ctermfg=0   ctermbg=222   cterm=NONE

   " marks column
   hi SignColumn      ctermfg=144 ctermbg=235
   hi SpecialChar     ctermfg=71               cterm=none
   ...
   hi Statement       ctermfg=162               cterm=none
   ...
   hi Typedef         ctermfg=162
   hi Type            ctermfg=209                cterm=none
